...
const [text,newSetText]=useState("Enable Dark Mode");
const toogleStyle=()=>{
...
<button className="btn btn-primary my-3" onClick={toogleStyle}>{text}</button>
</div>
    </div>  
